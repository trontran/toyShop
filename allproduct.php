                ...
                <div class="col-4 pd-2 mx-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted"><span>Supplier: </span><?= $row['supplier_id'] ?></h6>
                            <h6 class="card-subtitle mb-2 text-muted"><span>Category: </span><?= $row['category_id'] ?></h6>
                            <a href="editproduct.php?id=<?= $row['product_id'] ?>" class="btn btn-primary">Edit</a>
                            <a href="deleteproduct.php?id=<?= $row['product_id'] ?>" class="btn btn-danger">Delete</a>
                        </div>
                    </div>
                </div>
            <?php endwhile; ?>
